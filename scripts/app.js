...
jquery$1('select').each(function () {
  var $this = jquery$1(this),
      numberOfOptions = jquery$1(this).children('option').length;
  ...
  $styledSelect.click(function (e) {
    e.stopPropagation();
    jquery$1('div.select-styled.active').not(this).each(function () {
      jquery$1(this).removeClass('active').next('ul.select-options').hide();
    });
    jquery$1(this).toggleClass('active').next('ul.select-options').fadeToggle(120);
  });

  $listItems.click(function (e) {
    e.stopPropagation();
    $styledSelect.text(jquery$1(this).text()).removeClass('active');
    $this.val(jquery$1(this).attr('rel'));
    $list.hide();
    //console.log($this.val());
  });

  jquery$1(document).click(function () {
...
var Dropdown = function Dropdown() {
  ...
  var $listToggler = jquery$1('.js-list-toggler');
  var $list = jquery$1('.js-list');
...
var Menu = function Menu() {
  var $burgerMenuIcon = jquery$1('.js-burger');
  var $burgerMenu = jquery$1('.burger-menu');
  var $burgerCloseBtn = jquery$1('.js-burger-close');
